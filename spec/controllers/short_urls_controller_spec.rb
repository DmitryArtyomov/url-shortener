...
RSpec.describe ShortUrlsController, type: :controller do
  ...
  describe 'index' do
    ...
    it 'has a list of the top 100 urls' do
      get :index, format: :json
      attrs = %i[id full_url title click_count short_code created_at]
      expect(parsed_response['urls']).to be_include(short_url.slice(attrs).as_json)
    end
  end
  ...
  describe 'show' do
    ...
    it 'increments the click_count for the url' do
      expect { get :show, params: { id: short_url.short_code }, format: :json }
